import style from "./GithubHome.module.css";
  ...
  return (
    <div className={style.body}>
      ...
      <div className={style.main}>
        {/* left box of class main which shows galaxy image */}
        <div className={style.main_galaxy_box}>
          <img src="https://i.postimg.cc/CMqzcQKd/galaxy.png" alt="poster" />
        ...
        {/* right side box which shows space image */}
        <div className={style.main_image_box}>
          <img src="https://i.postimg.cc/bN0dhSkh/space.png" alt="space" />
          {/* right side box which shows satelite image */}
          <div className={style.satelite}>
            <img src="https://i.postimg.cc/ZqLqdWJS/satelite-removebg-preview.png" alt="satelite" />
          </div>
        </div>
      </div>
        ...
        <div className={style.container_box}>
          ...
          <div className={style.container_circle}>
            ...
            <div>
              ...
              <p>Get your tickets now to join us.</p>
            </div>
            <div>{`->`}</div>
          </div>
          <div></div>
